...
uses
  ...
  IdIOHandlerStack, IdSSL, IdSSLOpenSSL, IdUDPClient;
...
//  IdUDPClient1.BoundIP := Edit1.Text;
//  IdUDPClient1.BoundPort := StrToInt(Edit2.Text);
  IdUDPClient1.Host := Edit1.Text;
  IdUDPClient1.Port := StrToInt(Edit2.Text);
  IdUDPClient1.Active := True;
  IdUDPClient1.Broadcast(Edit3.Text, IdUDPClient1.Port);
//  IdUDPClient1.SendBuffer(Edit1.Text, StrToInt(Edit2.Text), TIdBytes(Edit3.Text));
...
//    msgFromClient := AContext.Connection.IOHandler.ReadLn;
  ...
  slSendToServerData.BeginUpdate;
  slSendToServerData.Add(msgFromClient);
  slSendToServerData.EndUpdate;
...
////          slSendToClientData.BeginUpdate;
////          slSendToClientData.Add(IndyTextEncoding_ASCII.GetString(byteMsgToClient));
////          slSendToClientData.EndUpdate;
//
//          try
//            simple := TSimple.Create;
//            simple.AContext := aContext;
//            simple.bRead    := True;
//            simple.data := IndyTextEncoding_ASCII.GetString(byteMsgToClient);
//
////            CTS_Lock.Enter;
